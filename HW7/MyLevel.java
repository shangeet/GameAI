...
public class MyLevel extends Level{
	...
	/* Converts the given MyDNA into a level. This function has been implemented for you using the DNA characters defined in MyDNA.java. However, you may optionally choose to modify it and/or create an alternate DNA representation. 
	
	In the representatino provided, every gene is represented as two characters. 
	
	The first character is one of 
	MyDNA.{STRAIGHT_CHAR,GAP_CHAR,COINS_CHAR,HILL_CHAR,MONSTERS_CHAR} which represents the span type. 
	
	The second char is a number 0 through 9 indicating the length of the span. The gene is decoded in order to invoke member functions (e.g. straight) that modify the level as indicated.*/
